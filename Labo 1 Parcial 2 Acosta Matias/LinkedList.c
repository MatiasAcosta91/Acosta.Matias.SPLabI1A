...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if (this != NULL && nodeIndex >= 0 && nodeIndex <= ll_len(this))
    {
        pNuevoNodo = (Node*) malloc (sizeof(Node)*1);
        if (pNuevoNodo != NULL)
        {
    ...
    if (this != NULL && pFunc != NULL && order >=0 && order <=1)
    {
        ...
        do
        {
            ...
            for (int i = 0; i < limite; i++)
            {
                ...
                resultado = pFunc(pElemento1,pElemento2);
 ...
 * \return LinkedList* LinkedList nuevo con los elementos que pasan el filtrado o Null en caso de error en los parametros
 *
 */
...
int ll_initArrayLinkedList(LinkedList* arrayLinkedList[], int tam)
{
    int retorno = 0;
    if (arrayLinkedList != NULL && tam>0)
    {
        for (int i = 0; i < tam; i++)
        {
            arrayLinkedList[i] = NULL;
            retorno = 1;
        }
    }
    return retorno;
}
int ll_deleteArrayLinkedList(LinkedList* arrayLinkedList[], int tam)
{
    int retorno = 0;
    if (arrayLinkedList != NULL && tam>0)
    {
        for (int i = 0; i < tam; i++)
        {
            ll_deleteLinkedList(arrayLinkedList[i]);
            retorno = 1;
        }
    }
    return retorno;
