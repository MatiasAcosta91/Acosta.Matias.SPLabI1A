...
int sortEmpleadosSueldo(void* a, void* b);
int main(void)
{
    ...
    printf("\n\n\n");
    //      19- PRUEBA ll_sort
    printf("Sort del listado anterior por sueldo decreciente\n");
    ll_sort(lista4,sortEmpleadosSueldo,1);
    mostrarEmpleados(lista4);


    //      8- PRUEBA ll_remove
    printf("\n\nElimino al empleado del indice 1 con ll_remove\n");
